...
public class HidingNavigationBarManager: NSObject, UIScrollViewDelegate, UIGestureRecognizerDelegate {
	...
	public init(viewController: UIViewController, scrollView: UIScrollView){
		...
		NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(HidingNavigationBarManager.applicationDidBecomeActive), name: UIApplicationDidBecomeActiveNotification, object: nil)
	}
